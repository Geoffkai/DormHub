...
│   │   ├── installers/    InstallForge output, including `DormHub-Setup.exe`
...
The current repository already includes a ready-made InstallForge package. To use it, download `Thumbler_sa_ref/DormHub/installers/DormHub-Setup.exe` and run the installer on Windows.
